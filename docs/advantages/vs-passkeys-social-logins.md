...
|--------|--------------------------|--------------|
| **UX: Setup** | Requires account with email, password, or phone number. Most [passkeys & social logins](https://x.com/joenrv/status/1857609397607813171) bind auth to that account. | Passkey-like onboarding with no pre-existing account requirement.
